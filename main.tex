        ...
        \subsubsection{Phương pháp và cách tiếp cận dự kiến}
            ...
            \begin{enumerate}[label=\textbf{\alph*.}]
                ...
                \begin{itemize}
                    ...
                    \item Smart Contract: Hợp đồng thông minh tương tác với blockchain để quản dữ liệu on-chain, đồng thời thực thi các tiến trình quan trọng như: tính toán chỉ số uy tín, cập nhật kết quả lưu trên chuỗi, thực hiện các biện pháp phạt theo quy ước. 
