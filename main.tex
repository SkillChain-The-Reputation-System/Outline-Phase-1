...
\begin{center}
    \begin{tabular}{ p{7cm} p{7cm} }
        \textbf{
            \begin{tabular}[c]{@{}c@{}}                  \\
                \large XÁC NHẬN CỦA GVHD \\
                \textit{\large(Ký và ghi rõ họ tên)}
            \end{tabular}
        }
         & \textbf{
            \begin{tabular}[c]{@{}c@{}}
                \textit{\large Tp. Hồ Chí Minh, ngày 14 tháng 9 năm 2025} \\
                \large NHÓM SINH VIÊN THỰC HIỆN                          \\
                \textit{\large(Ký và ghi rõ họ tên)}\end{tabular}
        }
    \end{tabular}
\end{center}

\begin{textblock*}{7cm}(2.8cm,22.5cm) % (x,y) từ góc trên trái
  \includegraphics[width=7cm]{advisor_signature.jpg}
\end{textblock*}

\begin{textblock*}{9.5cm}(10.2cm,22.5cm) % (x,y) từ góc trên trái
  \includegraphics[width=9.5cm]{students_signature.jpg}
\end{textblock*}
